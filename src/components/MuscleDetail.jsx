  ...
  return (
    <div className="muscleDetailPage">
      ...
      <div className="øvelser">
        ...
        <div className="øvelseInfo">
          ...
          <p>
            ...
            liggende posisjon på en benk. For å utføre benkpress korrekt: 1.
            Ligg på ryggen på en benk med føttene flatt på gulvet. 2. Hold
            stangen med et grep som er litt bredere enn skulderbredde. 3. Senk
            stangen kontrollert ned til brystet, og trykk den deretter tilbake
            til utgangsposisjonen med kraft. Benkpress er en av de mest brukte
      ...
      <div className="øvelser">
        <h3>Cable Flyes</h3>
        <div className="øvelseInfo">
          <img className="cardImg" src="/public/cableFlyes.webp" alt="chest" />
          <p>
            Cable flyes er en styrketreningsøvelse som primært trener
            brystmusklene (pectoralis major). Øvelsen utføres ved hjelp av
            kabelmaskiner, og gir en konstant spenning gjennom hele bevegelsen,
            noe som gir en effektiv trening for brystet. For å utføre cable
            flyes: 1. Juster kabelmaskinen til øyehøyde og fest håndtakene på
            begge sidene. 2. Ta tak i håndtakene med begge hender og stå i en
            stabil posisjon, med et lite bøy i knærne. 3. Trekk hendene sammen
            foran kroppen, og fokuser på å klemme brystmusklene på toppen. 4.
            Senk langsomt hendene tilbake til utgangsposisjonen, og kontroller
            bevegelsen. Cable flyes er en flott øvelse for å isolere
            brystmusklene og for å forbedre brystets form og definisjon.
          </p>
        </div>
      </div>
